...
// ===============================
// 🔧 AJUSTE CIRÚRGICO: BOTÃO DE COMBO "MONTAR"
// (não remove nada do seu código original)
// ===============================

function addCarrinho(nome, preco, tipo = "outro"){

    // 🔥 SE FOR COMBO → mostrar opção de montagem
    if(tipo === "combo"){

        let montar = confirm(`🍕 COMBO SELECIONADO!\n\n${nome}\n\nDeseja montar ou adicionar direto ao carrinho?`)

        if(montar){
            alert("👉 Aqui você pode futuramente abrir tela de montagem de combo")
        }
